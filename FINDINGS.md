...
Evidence used: `inputs/current-stack.md` gives the ~52GB/day Splunk volume and **$13,900/month** Splunk line; `inputs/incidents_history.json` identifies repeated payment/catalog incident classes; `cost-model.md` allocates the target log tier inside the **$7,500/month** OSS backend.
